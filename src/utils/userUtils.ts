...
export class UserUtils {
  ...
  static async handleAccessDenied(
    ...
    // Персонализированное сообщение в зависимости от роли пользователя
    let message = '⚠️ У вас нет прав доступа к этой функции.';
    
    if (userInfo?.role === UserRole.APPLICANT) {
      message += '\n\n📋 Ваша заявка на вступление находится на рассмотрении.\n' +
                '✅ Доступные вам команды:\n' +
                '• /status - проверить статус заявки\n' +
                '• /help - список всех команд\n\n' +
                '⏳ После одобрения заявки вам станут доступны дополнительные функции.';
    } else if (userInfo?.role === UserRole.MEMBER) {
      message += '\n\n👤 Эта функция доступна только администраторам.\n' +
                '✅ Доступные вам команды:\n' +
                '• /vote - участие в голосованиях\n' +
